...
class App extends Component {
  ...
  getFilterProjectList = () => {
    ...
    const filterProjectList = projectsList.filter(
  ...
  render() {
    const filterProjectList = this.getFilterProjectList()
    const {activeTabId} = this.state
    return (
        ...
        <ul className="tabs-container">
          {tabsList.map(tabDetails => (
            <TabItem
              ...
              isClicked={activeTabId === tabDetails.tabId}
            />
          ))}
        </ul>

        <ul className="project-list-container">
          {filterProjectList.map(projectDetails => (
            <ProjectItem
